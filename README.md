...
**提醒**：GreatSQL 8.0.32-24版本开始支持在MGR的读写节点上绑定动态VIP以实现高可用，推荐升级到该版本，详情请参考：[GreatSQL中MGR支持内置vip特性](https://github.com/GreatSQL/GreatSQL-Doc/blob/main/relnotes/greatsql-803224/mgr-vip.md)。
